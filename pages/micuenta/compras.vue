      ...
      <div v-if="!compras?.length" class="h-full flex justify-center items-center"  >
        <div class="pb-20 text-white text-center">
          <IconsNuevasCompras class="w-32 fill-white mx-auto" />
            <p class="py-4 text-2xl font-bold">  Aun no tienes compras</p>  <NuxtLink to="/productos" class="mx-auto border bg-white/10 px-4 py-2 rounded-md">Agregar Productos</NuxtLink> </div>
        </div>
    </div>
  </div>
</template>
