...
<template>
  <div class="md:flex gap-4 max-w-5xl mx-auto p-5">
    ...
    <div class="w-full text-white">
      <div>
        <NuxtLink to="/micuenta/compras" class="bg-white/10 py-2 px-4 rounded-xl">
      ...
      <div class="flex gap-3 pt-4">
        ...
        <div class="w-full">
          ...
          <div class="p-4 bg-white/10 rounded-xl flex gap-3">
            <img v-if="compra?.deliveryCompanyImgUrl" :src="compra.deliveryCompanyImgUrl" class="rounded-xl w-20"
              alt="" />
            <div class="font-thin">
