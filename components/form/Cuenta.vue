                ...
                <div class="grid md:grid-cols-2 gap-3 p-2">
                    ...
                    <div class="w-full">
                        ...
                        <input v-model="client.email" required id="email" type="email"
                            class="py-2 w-full px-4 mt-2 rounded-lg  bg-white border" readonly />
                    </div>
                </div>
                <div class="grid md:grid-cols-3 gap-3 p-2">
                    <div class="w-full">
                        ...
                        <input v-model="client.phone" required type="number"
                            class="py-2 w-full px-4 rounded-lg  bg-white mt-2 border" placeholder="Celular" />
                    </div>
                    <div class="w-full">
                        <label for="docType" class="text-white">Tipo de Documento:</label>
                        <select v-model="client.docType" required id="docType"
                            class="py-2.5 w-full px-4 rounded-lg  bg-white mt-2 border">
                    ...
                    <div class="w-full">
                        ...
                        <input v-model="client.docId" required type="number"
                            class="w-full py-2 px-4 rounded-lg  bg-white mt-2 border"
            ...
            <div class="grid md:grid-cols-2 gap-3 p-2">
                <div class="w-full">
                    ...
                    <input required v-model="client.address" type="text" id="address"
                        class="w-full py-2 px-4 rounded-lg  bg-white mt-2 border" placeholder="Dirección" />
                </div>
                <div class="w-full">
