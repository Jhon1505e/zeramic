...
<template>
    <form @submit.prevent="emit('submit')">
          <div class="mt-4 mx-8   md:mx-auto" :class="Router.currentRoute.value.path === '/compras/envio' ? 'flex gap-4 w-1/2' : 'block w-3/4'" >
            <div class="w-full">
            ...
            <button :class="Router.currentRoute.value.path === '/compras/envio' ? 'w-1/3 ' : 'w-full mt-4'" class="border bg-white/20 mx-auto block  rounded-xl p-2 text-white" type="submit">
              Ingresar
            </button>
          </div>
