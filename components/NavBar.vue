<template>
  <div class="bg-PRP h-20 sticky top-0 w-full z-20">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="w-full justify-around lg:justify-center flex pt-3">
        ...
        <div class="hidden lg:flex justify-end bg w-full pt-4 pl-20 duration-300">
          <NuxtLink class="text-white text-2xl pb-1 px-3 duration-100 ease-in font-extralight" to="/productos">
            Productos
          </NuxtLink>
          <NuxtLink class="text-white text-2xl pb-1 px-3 duration-100 ease-in font-extralight" to="/nosotros">
            Nosotros
          </NuxtLink>
          <NuxtLink class="text-white text-2xl pb-1 px-3  duration-100 ease-in font-extralight" to="/micuenta">
            Mi Cuenta
          </NuxtLink>
          <NuxtLink class="text-white text-2xl pb-1 px-3 mr-10 duration-100 ease-in font-extralight" to="/contacto">
            Contacto
          </NuxtLink>
        </div>
        <div class="flex w-full sm:w-auto justify-end gap-1 mt-3 md:mt-0">
          <div @click="open = true" v-show="!isCompras"
            ...
            <div class="sm:p-5">
              <IconsBag class="w-8 sm:w-7 z-10 fill-white" />
            </div>
          </div>
